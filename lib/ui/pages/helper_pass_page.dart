...
class HelperPassPage extends StatelessWidget {
  const HelperPassPage({super.key});
        ...
        child: Column(
          children: [
            ...
            Expanded(
              ...
              loader: (page) => HelperPassService().getSampleHelperPasses(),
      ...
      child: Row(
        children: [
          ...
          Text(
            status,
            style: TextStyle(
              color: status == 'Cleared' ? Colors.green : Colors.red,
              fontWeight: FontWeight.bold,
            ),
          ),
        ],
